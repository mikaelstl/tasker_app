...
export const Toasts = {
  'info': (content: string) => toast.info(content, {
    style: { backgroundColor: Palette.green_25, color: Palette.white },
    icon: <CheckIcon fill={Palette.white} width={16}/>
  }),
  'warning': (content: string) => toast.warn(content, {
    style: { backgroundColor: Palette.yellow_25, color: Palette.white },
  ...
  'critical': (content: string) => toast.warning(content, {
    style: { backgroundColor: Palette.red_25, color: Palette.white },
